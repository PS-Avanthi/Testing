...
public class Barnesnoble {
   ...
   final Logger lobj = Logger.getLogger(getClass());
    ...
    {  
        FileInputStream fs=new FileInputStream("C:/Users/avant/Desktop/testing/CoC2/CC2/ccexcel.xlsx");
    ...
    public void tearDown(ITestResult result)throws Exception
    {
        if(result.getStatus()==ITestResult.FAILURE)
        {
            ...
            String screenShotPath = "C:\\Users\\avant\\Desktop\\testing"+result.getName()+".png";
